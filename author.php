<?php legalhelp_bunch_global_variable(); 
	...
	$layout = legalhelp_set( $settings, 'author_page_layout', 'right' );
	$sidebar = legalhelp_set( $settings, 'author_page_sidebar', 'blog-sidebar' );
	$view = legalhelp_set( $settings, 'author_page_view', 'list' );
	...
	$bg = legalhelp_set($settings, 'author_page_header_img');
	$title = legalhelp_set($settings, 'author_page_header_title');
?>
<!--Page Title-->
